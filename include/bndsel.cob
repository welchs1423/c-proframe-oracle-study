      ...
      ***************************************************************
       01  BNDDSC.
           ...
           02  BNDDVAR             OCCURS 20 TIMES.
               03 BNDDV            PIC S9(18) COMP-5.
               03 BNDDFMT          PIC S9(18) COMP-5.
               03 BNDDVLN          PIC S9(9) COMP-5.
               03 BNDDFMTL         PIC S9(4) COMP-5.
               03 BNDDVTYP         PIC S9(4) COMP-5.
               03 BNDDI            PIC S9(18) COMP-5.
               03 BNDDH-VNAME      PIC S9(18) COMP-5.
               03 BNDDH-MAX-VNAMEL PIC S9(4) COMP-5.
               03 BNDDH-CUR-VNAMEL PIC S9(4) COMP-5.
               03 BNDDFILL1        PIC S9(9) COMP-5.
               03 BNDDI-VNAME      PIC S9(18) COMP-5.
               03 BNDDI-MAX-VNAMEL PIC S9(4) COMP-5.
               03 BNDDI-CUR-VNAMEL PIC S9(4) COMP-5.
               03 BNDDFILL2        PIC S9(9) COMP-5.
               03 BNDDFCLP         PIC S9(18) COMP-5.
               03 BNDDFCRCP        PIC S9(18) COMP-5.
           02 SQLBNDCP             OCCURS 20 TIMES PIC S9(9) COMP-5.
       01  XBNDDI.
